...
SITE_IDENTIFIER = 'streamimdb'
SITE_NAME = 'stream IMDB'
SITE_ICON = 'streamimdb.png'

DOMAIN   = getSetting('plugin_' + SITE_IDENTIFIER + '.domain', 'streamimdb.ru')
URL_MAIN = 'https://' + DOMAIN

URL_NEW    = URL_MAIN + '/movies/'
URL_KINO   = URL_MAIN + '/movies/'
URL_MOVIES = URL_MAIN
URL_SERIES = URL_MAIN + '/tv-shows/'
URL_SEARCH = URL_MAIN + '/search/'
