...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR darkcyan]JayTv Plus [/COLOR]All In One Wizard'
BUILDERNAME = 'JayTv Plus Wizard'
EXCLUDES = [ADDON_ID, 'repository.openwizard']
# Text File with build info in it.
BUILDFILE = 'https://thunderv3.github.io/build/builds.txt'
# How often you would like it to check for build updates in days
# 0 being every startup of kodi
UPDATECHECK = 0
# Text File with apk info in it.  Leave as 'http://' to ignore
APKFILE = 'https://thunderv3.github.io/build/apks.txt'
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]JayTv Plus[/B][/COLOR][COLOR {color2}]All In One Wizard[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
HIDECONTACT = 'No'
# You can add \n to do line breaks
CONTACT = 'Thank you for choosing The JayTv Plus All In One Wizard.'
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR darkcyan]JayTv Plus [/COLOR]All In One Dienst'
